...
#### 1.1.1. Run the base driver:
    ...
    roslaunch go1_gazebo bringup.launch rviz:=true
...
#### 1.2.2. Run gmapping package and move_base:
    ...
    roslaunch go1_gazebo slam.launch rviz:=true
...
#### 1.3.2. Run amcl and move_base:
    ...
    roslaunch go1_gazebo navigate.launch rviz:=true
...
Spawning a robot:
    ...
    roslaunch go1_gazebo spawn_robot.launch robot_name:=<unique_robot_name> world_init_x:=<x_position> world_init_y:=<y_position>
