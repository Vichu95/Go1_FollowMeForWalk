...
#include "go1_legged_msgs/SetBody.h"
...
namespace qre{
    ...
    public:
        ...
        bool setBodyCallback(go1_legged_msgs::SetBody::Request &req, go1_legged_msgs::SetBody::Response &res);
